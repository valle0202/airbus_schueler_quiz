...
/*
* Schlussbildschirm mit Score und Informationen über Airbus 
*/
...
class _EndeState extends State<Ende> {
  ...
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((_) => setState(() {
          bottomColor = highlightColor3F;
        }));
    FirebaseFirestore.instance
        .collection('punkte')
        .add({widget.personalPassword: widget.punktzahl});
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Stack(children: [
                  ...
                  child: Center(
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            'Die Zeit ist abgelaufen vielen Dank für die Teilnahme! Du hast: ' +
                                widget.punktzahl.toString() +
        ...
        Center(
            child: Image.asset(
          "assets/images/Airbus_CarbonGridAusschnitt.png",
          scale: 5,
        )), //sieht nicht gut aus :(
      ]),
    );
