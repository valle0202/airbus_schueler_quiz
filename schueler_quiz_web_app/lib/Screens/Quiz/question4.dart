  ...
  return Padding(
    ...
    child: Column(
      ...
      children: [
        ...
        Flexible(flex: 12, child: Image(image: AssetImage("assets/images/Aufgabe_4_Ver_4_Weiss.png"),)),
        Flexible(
          flex: 1,
            child: Text('Gebe die Reihenfolge der Flugplätze an.',
            style: Theme.of(context).textTheme.bodyText1,
          ),
        ),
        Flexible(
          flex: 1,
            child: Text('Beispiel zum Eingabeformat: "5; 6; 1; 8; 3; 9; 2; 4; 7; 5"',
            style: Theme.of(context).textTheme.bodyText1,
          ),
        ),
        //answer(500),
